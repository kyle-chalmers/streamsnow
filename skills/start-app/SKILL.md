...
| Phase | What the user runs | Checkpoint after |
|---|---|---|
...
- **Wizard, not executor.** The only Bash this skill runs is read-only verification (`ls`, `test`, `grep`). It tells the user what to type; it does not silently run their skills.
