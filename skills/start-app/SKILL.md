...
2. **Requirements.** Tell the user to run `/refine-requirements` (Jira `PROJ-XXXX`, `--new`, or existing slug). Confirm `apps/<slug>/REQUIREMENTS.md` exists with §4 Pages and §11 Build Progress.
